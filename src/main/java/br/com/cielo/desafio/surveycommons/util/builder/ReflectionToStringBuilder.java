...
import br.com.cielo.desafio.surveycommons.util.ObjectUtils;
        ...
        for (final Field field : fields) {
            ...
            if (this.accept(field)) {
                try {
                	...
                	if (field.isAnnotationPresent(MaskedToStringValue.class) && ObjectUtils.notEmpty(fieldValue)) {
                		final String maskedFieldValue = field.getAnnotation(MaskedToStringValue.class).mask();
                		this.append(fieldName, maskedFieldValue);
                	} else {
